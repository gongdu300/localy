...
def search_places_tool(region: str, category: str, preference: str = None) -> dict:
    ...
    Args:
        ...
        preference: 선호도
    """
    from agents.search.landmark_agent import search_landmarks, TOURIST_CATEGORIES
...
def get_landmark_detail_tool(place_id: str) -> dict:
    ...
    """
    from agents.search.landmark_agent import get_landmark_detail
...
def find_nearby_landmarks_tool(
    ...
    """
    from agents.search.landmark_agent import find_nearby_landmarks
...
def recommend_by_season_tool(
    ...
    """
    from agents.search.landmark_agent import recommend_by_season
...
def recommend_by_time_tool(
    ...
    """
    from agents.search.landmark_agent import recommend_by_time
