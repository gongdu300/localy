...
origins = [
    ...
    "http://localhost:3002",  # Vite 자동 포트 변경
    "http://localhost:3009",  # TTS 테스트
    "http://localhost:5173",
    "http://127.0.0.1:3000",
    "http://127.0.0.1:3001",  # Vite 자동 포트 변경
    "http://127.0.0.1:3002",  # Vite 자동 포트 변경
    "http://127.0.0.1:3009",  # TTS 테스트
    "http://localhost:5000",
    "http://127.0.0.1:5000",
    "http://localhost:5173",
    "http://127.0.0.1:5173",
...
app.include_router(langgraph.router)  # LangGraph ReAct Agent 라우터 등록
